...
install -v -o 1000 -g 1000 -D files/hub-connect2_${hubconnect2}_all.deb ${ROOTFS_DIR}/home/pi/debs
...
apt -y install hubaccess pushkeys pumpkin-config sensei2 hub-connect2
