...
#
# AMONIS: 05/05/2018: 
# To build the first stage uncomment ### lines and comment the two below. 
# Checkin and push. When built repeat process in reverse. 
#
# alternates for first and subsequent elements
###stages="declare -a STAGES=(0 1 2)"   # this hack expands to a declaration of an array that gets fed into the build script in docker container
###PI_GEN="pi-gen"
stages="declare -a STAGES=(3 4 5)"
